...
namespace cabin {
    ...
    public:
         ...
         *
         *  This function will handle necessary inputs and mouse conflict with ImGui.
         *
         * @note Using this method has the following side-effects:
                ...
                3. `GLFW_RAW_MOUSE_MOTION` will be enabled, if supported.
                
                If any of the above behaviors is unexpected, 
